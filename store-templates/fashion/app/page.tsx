...
import { ShoppingBag, Heart, Search, User, ChevronRight } from "lucide-react"
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              {categories.map((category) => (
                <a key={category} href="#" className="text-sm font-medium transition-colors hover:text-gray-500">
                  {category}
                </a>
              ))}
            </nav>
