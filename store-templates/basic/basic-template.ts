...
// Basic store template files
export function getBasicStoreTemplate(options: VercelDeploymentOptions): Record<string, { file: string }> {
  return {
...
function getPackageJson(options: VercelDeploymentOptions): string {
  return `{
  "name": "${options.name ? options.name.toLowerCase().replace(/\\s+/g, "-") : "storex-basic-template"}",
  "version": "0.1.0",
  "private": true,
  "scripts": {
    "dev": "next dev",
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-blue-600">${options.name || "StoreX"}</h1>
            </div>
                ...
                >
                  <div className="bg-gray-100 rounded-lg p-6 text-center transition-all group-hover:bg-blue-50 group-hover:shadow-md">
                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm">
                      {category === "Electronics" && <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>}
                      {category === "Clothing" && <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600"><path d="M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z"/></svg>}
                      {category === "Home" && <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>}
                      {category === "Beauty" && <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600"><path d="M8 3h8l4 9-8 10-8-10Z"/><path d="m12 22 4-11-8-8"/><path d="m12 22-4-11 8-8"/><path d="M9 11h6"/></svg>}
                    </div>
      ...
      <footer className="bg-gray-900 text-white pt-12 pb-6">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-xl font-bold mb-4">${options.name || "StoreX"}</h3>
          ...
          <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">© ${new Date().getFullYear()} ${options.name || "StoreX"}. All rights reserved.</p>
...
export const metadata: Metadata = {
  title: "${options.name || "StoreX"} - Modern eCommerce Store",
  description: "A professional eCommerce store built with StoreX",
}
